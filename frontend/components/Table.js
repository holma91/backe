...
export const SelectColumnFilter = ({ column: { filterValue, setFilter, preFilteredRows, id, render } }) => {
    ...
    return (
        <div className="flex items-center">
            <div>
                ...
                <div className="text-sm text-gray-500">{row.original[column.addressAccessor]}</div>
            </div>
        </div>
    );
};
...
export const PageCounter = ({ pageCurrent, pageMax }) => (
    <>
        Page <span className="font-medium">{pageCurrent}</span> of <span className="font-medium">{pageMax}</span>
    </>
);
...
export const ChangePage = ({ canPreviousPage, canNextPage, previousPage, nextPage, gotoPage, pageCount }) => (
    <div>
