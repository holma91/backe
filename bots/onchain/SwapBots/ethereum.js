import evmTransactionTracker from './evmTransactionTracker.js';
...
const exchange_addresses = require('../random_data/exchange_addresses.json');
...
let exchanges = exchange_addresses.map((obj) => obj['address'].toLowerCase());
let addresses = Object.keys(eth_addresses).filter((address) => !exchanges.includes(address));
